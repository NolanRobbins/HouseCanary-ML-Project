...
with open("HouseCanary_model.pkl", "rb") as f:
    model = pickle.load(f)

# Ensure this is the actual RobustScaler object, not the scaled data
with open("robust_scaler.pkl", "rb") as f:  # Rename to the correct scaler file
    scaler = pickle.load(f)

# Load the columns from X_train_new and X_train_selected
X_train_scaled = pd.read_excel("X_train_scaled.xlsx")
X_train_selected = pd.read_excel("X_train_selected.xlsx")
